      ...
      if (isset($_SESSION["email"]))
      {
        if (isset($_POST["submit33"])) 
        {
            ...
            if (isset($_POST["id1"]) && isset($_POST["id2"])) 
            {
              ...
              $search=$cnx->prepare("delete from abonne where id=:id1 and id2=:id2");
    ...
    <div class="fm">
      ...
      <ul class="ca bow box afa">
        ...
        <?php
          ...
          $search=$cnx->prepare("SELECT * from utilisateur where email != :email and id in (select id2 from abonne where id = :id)");
                ...
                <div class="fm">
                  <div class="pz bpi afa">
                    ...
                    <div class="qa avz">
                      ...
                      <button class="cg nz ok" type="submit" name="submit33"><span class="h ayi"></span> DiFollow</button>
                    </div>
                  </div>
                </div>
