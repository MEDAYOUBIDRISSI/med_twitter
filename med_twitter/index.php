...
<!-- Mirrored from bootstrap-themes.github.io/application/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Mar 2019 14:48:39 GMT -->
      ...
      <ul class="ca bow box afo">
        ...
        <!-- <li class="rv b agz">
          <div class="input-group">
            ...
            <div class="bpt">
              <button type="button" class="cg ns yf" style="background-color: white;border-left-width: 0px;">
                <i class="far fa-images" style="color: #1da1f2;"></i>
              </button>
            </div>
          </div>
        </li> -->
        <?php
          $search=$cnx->prepare("SELECT u.email,u.nom,u.nom2,u.image,u.background,u.abonne,u.twette,m.* FROM utilisateur u inner join message m ON u.id=m.id order by temps desc");
          $search->execute();
          while ($donne1=$search->fetch()){ ?>
        <li class="rv b agz">
          <img
